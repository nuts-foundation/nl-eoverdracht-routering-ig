...
Sending Organizations have to use the following eOverdracht-Task profile: [http://minvws.github.io/generiekefuncties-docs/StructureDefinition/nl-gf-task-stu3](https://minvws.github.io/generiekefuncties-docs/en/StructureDefinition-nl-gf-task-stu3.html)
